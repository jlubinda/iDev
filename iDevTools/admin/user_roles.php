...
else 
{
	...
	$bgcolor = "ddffff";
		...
		{
		$delete = "DELETE FROM _bx_refer_users_types WHERE UserTypeCode = '".$_REQUEST["UserTypeCode"]."';";
		...
		<?php
			...
			$sql21 = "INSERT INTO _bx_refer_users_types (UserTypeCode,UserTypeName,UserTypeCategory,LimitedTo,_used,_uid) VALUES ('".$_REQUEST["UserTypeCode"]."','".$_REQUEST["UserTypeName"]."','".$_REQUEST["UserTypeCategory"]."','".$_REQUEST["LimitedTo"]."','','');";
	...
	if($bx_permissions=="Yes")
	{
		...
		$delete = "UPDATE _bx_refer_users_types SET Roaming = '".$_REQUEST["status"]."' WHERE UserTypeCode = '".$_REQUEST["typeID"]."';";
		$res = mysqli_query($db,$delete);
