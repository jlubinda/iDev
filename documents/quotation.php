...
$pdf->SetTitle('QUOTATION - '.strtoupper($value["names"]).' '.date("d-m-Y"));
...
email('QUOTE NO. Q'.strtoupper($_SESSION["uniqueCode"]),$html,"info@citydriverentacar.com",$_SESSION['CustomerEmail'],"reservations@citydriverentacar.com");
...
$pdf->Output('QUOTATION - '.$_SESSION['CustomerEmail'].' '.date("d-m-Y").'.pdf', 'I');
