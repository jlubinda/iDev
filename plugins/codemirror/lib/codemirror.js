...
(function(mod) {
  ...
  function drawSelectionRange(cm, range, output) {
    ...
    function drawForLine(line, fromArg, toArg) {
      ...
      iterateBidisegments(getOrder(lineObj), fromArg || 0, toArg == null ? lineLen : toArg, function(from, to, dir) {
  ...
  function iterateBidisegments(order, from, to, f) {
  ...
  // (left-to-right), or an array of segments ({from, to, level}
