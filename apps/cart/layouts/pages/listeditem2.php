	...
	..
		...
		<input type="hidden" id="item<?php echo $s;?>_duration" value="0">
		    <div class="row">
               ...
               <div class="input-field col s6">      
                   <input placeholder="Drop off Town" id="item<?php echo $s;?>_DropOffTown" type="text"  name="pick" class="validate"  />
			...
			<div class="row">
				...
				<div class="input-field col s6">      
					<input placeholder="Driving To: Town, Country" id="item<?php echo $s;?>_DrivingTo" name="pick" class="validate"  />
			...
			<div class="row">
               <div class="input-field col s6">
                  ...
                  <input placeholder="No.of Adults"  id="item<?php echo $s;?>_NoOfAdults" type="text" name="quantity" class="validate"  />
                  <label for="item<?php echo $s;?>_NoOfAdults"> </label>
               </div>
               <div class="input-field col s6">      
                   <input placeholder="No.of Children" id="item<?php echo $s;?>_NoOfChildren" type="text" name="quantity" class="validate"  />
                  <label for="item<?php echo $s;?>_NoOfChildren"></label>   
               </div>
            </div>
		<button onclick="cart('item<?php echo $s;?>');Materialize.toast('Item Added to Cart<a class=&quot;btn-flat yellow-text&quot; href=?ref=accessories.html>Click here to add accessories!<a>', 5000);" href="" class="btn modal-trigger         red darken-2  " style="">Add To Cart</button>
	</div>
