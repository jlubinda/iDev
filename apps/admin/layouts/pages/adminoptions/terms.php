...
router(array("HEADER","website"),"","",'','','file','');
	...
	<div style="padding: 5px;">
			...
			<div style="margin:5px; padding:5px; background-color:#444; width:93%;"><div style="padding:7px;"><b>TERMS:</b> </div><div style="float: right;"><textarea name="terms" rows="5" cols="100"><?php echo getTerms();?></textarea></div></div>
	...
	<div style="width:60%; min-width: 320px;">
		<div style="min-width:280px; width:100%; background-color:#333; padding:5px; margin-left:5px; margin-left:5px; margin-left:5px; margin-bottom:50px; color:#fff;">
				<div style="margin:5px; width:300px;; padding:5px; background-color:#555;"><div style="padding:7px; background-color:#222;"><strong><?php echo getTerms();?></strong></div><a href="?ref=<?php echo $_REQUEST['ref']; ?>&id=<?php echo getTerms("ID");?>&function=delete"><div style="margin:5px;">DELETE</div></a></div>
		</div>
	</div>
		</div>
	</div>
