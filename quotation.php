...
/*
	names=<?php echo $first_name." ".$last_name;?>&qty=<?php echo $numDays;?>&price=<?php echo getActualPrice($_REQUEST["id"],$_REQUEST['fromcity'],$typed);?>&mileage_charge=<?php echo $mileage_charge;?>&distance=<?php echo $distance;?>&driver_rate=<?php echo $driver_rate;?>
*/
// set document information
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('PayItApp.co');
$pdf->SetTitle('QUOTATION - '.strtoupper($_REQUEST["names"]).' '.date("d-m-Y"));
$pdf->SetSubject('VEHICLE HIRE');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData('logo.png', PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.' 006', PDF_HEADER_STRING);
...
List example:
<ol>
	<li><img src="images/logo.png" alt="test alt attribute" width="30" height="30" border="0" /> test image</li>
	<li><b>bold text</b></li>
...
<img src="images/logo.png" alt="test alt attribute" width="100" height="100" border="0" /><img src="images/tcpdf_box.svg" alt="test alt attribute" width="100" height="100" border="0" /><img src="images/logo.jpg" alt="test alt attribute" width="100" height="100" border="0" />
</div>';
...
<tr><td><img src="images/logo.png" border="0" height="41" width="41" /></td></tr>
<tr style="text-align:left;"><td><img src="images/logo.png" border="0" height="41" width="41" align="top" /></td></tr>
<tr style="text-align:center;"><td><img src="images/logo.png" border="0" height="41" width="41" align="middle" /></td></tr>
<tr style="text-align:right;"><td><img src="images/logo.png" border="0" height="41" width="41" align="bottom" /></td></tr>
<tr><td style="text-align:left;"><img src="images/logo.png" border="0" height="41" width="41" align="top" /></td></tr>
<tr><td style="text-align:center;"><img src="images/logo.png" border="0" height="41" width="41" align="middle" /></td></tr>
<tr><td style="text-align:right;"><img src="images/logo.png" border="0" height="41" width="41" align="bottom" /></td></tr>
</table>';
